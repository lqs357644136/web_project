        ...
        <template slot-scope="props">
          <el-form label-position="left" inline>
            ...
            <el-form-item label="发出时间">
              <span class="listInfoContent">{{ props.row.startTime | dataFormat('yyyy-MM-dd')}}</span>
            </el-form-item>
            <el-form-item label="时长(分钟)">
              <span class="listInfoContent">{{ props.row.duration }}</span>
            </el-form-item>
          </el-form>
        </template>
      </el-table-column>
      <el-table-column prop="plant" label="车间"></el-table-column>
      <el-table-column prop="ptno" label="产品"></el-table-column>
      <el-table-column prop="process" label="机台"></el-table-column>
      <el-table-column prop="startTime" label="发出时间">
        <template slot-scope="scope">
          <div>
            <i class="el-icon-time"></i>
            <span>{{ scope.row.startTime | dataFormat('yyyy-MM-dd hh:mm') }}</span>
          </div>
        </template>
      </el-table-column>
